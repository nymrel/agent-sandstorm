...
export class AuditLogger {
     ...
     */
    recordEvent(type, severity, payload = {}) {
    ...
    verifyIntegrity() {
        ...
        for (let i = 0; i < this.events.length; i++) {
            ...
            const computedHash = computeEventHash(event.index, event.prevHash, event.timestamp, event.type, event.severity, event.payload);
